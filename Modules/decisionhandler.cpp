...
DecisionHandler::DecisionHandler(QObject *parent) : QObject{parent} {
   ...
   *
   *  Syntax: m_treeMap["Active Question"] = {"Next Question on Yes", "Next
   *Question on No"};
   **/

  m_treeMap["Start"] = {"Participants with disabilities"};

  m_treeMap["Participants with disabilities"] = {"Hearing difficulty",
                                                 "Cognitive difficulty"};
  m_treeMap["Hearing difficulty"] = {"Vision difficulty(A)",
                                     "Vision difficult(B)"};
